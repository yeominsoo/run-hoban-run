...
싱글게임의 기존 기기 로컬 랭킹을 다른 사용자와 함께 볼 수 있도록 같은 WAS에 점수 API를 둔다.
nginx의 기존 `/ranking` prefix 프록시를 그대로 사용하므로 별도 location 추가는 필요 없다.
...
### 재배포 절차 (server.mjs/liar.mjs/mafia.mjs/halligalli.mjs/yutnori*.mjs/strategy-yutnori*.mjs/ranking-store.mjs/score-ranking-store.mjs/Dockerfile/package.json 변경 시)
