...
src/
  ...
  pages/           # 레이스 외 게임(hub/team/dice/rps/liar/mafia/halligalli)의 멀티페이지 진입점
...
**파티게임 3종 확장(라이어게임 → 마피아게임 → 할리갈리) 완료.** 설계 배경과 재사용 패턴은
`docs/party-games-handoff-2026-07-03.md`에 남아있다.
